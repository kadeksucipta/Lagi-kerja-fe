            ...
            <Form onSubmit={onSubmitHandler}>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label className="d-grid">
                  <strong>Tambahkan keahlian</strong>
                  <span className="note-text">*masukan skill satu persatu</span>
                </Form.Label>
