            ...
            <Form onSubmit={onSubmitHandler}>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label className="d-grid">
                  <strong>Tambahkan informasi pribadi</strong>
                  <span className="note-text">*masukan informasi pribadi</span>
                </Form.Label>
                ...
                <div style={{ display: "flex" }}>
                  ...
                  />
                  {/* <Button className="btn-saveskill" type="submit">Simpan</Button> */}
                </div>
                <Form.Label>No Hp aktif</Form.Label>
                <div style={{ display: "flex" }}>
                  <Form.Control
                    onChange={onChangeHandler}
                    value={user.hp}
                ...
                <div>
                  ...
                  />
                  <br />
                  <Button className="btn-saveinfo" type="submit">
                    Simpan
                  </Button>
                </div>
              </Form.Group>
